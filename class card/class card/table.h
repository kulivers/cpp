...
public:
	...
	static void DeleteItem(CCard card)         // ïðàëüíà??! NET
	{
		int n;
		...
		_cardsOnTable.erase(_cardsOnTable.begin() + n);// ÇÄÅÑÜ ÍÈ×ÅÃÎ ÍÅ ÏÐÎÈÑÕÎÄÈÈÒ

		//vecIntSecond.erase(vecIntSecond.begin() + 1);///ñòèðàåì 1 ýëåìåíò âåêòîðà

	}

	static CCard GetCard(int i)// òóò
	{
